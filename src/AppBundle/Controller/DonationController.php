...
class DonationController extends Controller
{
    ...
    public function frequencyAction(Request $request)
    {
        ...
        $donationFrequency = $this->get('app.donation_frequency_request.factory')->create(PayboxPaymentFrequency::DEFAULT_FREQUENCY);
    ...
    public function informationsAction(Request $request)
    {
        ...
        $donationFrequencyRequest = $factory->create($request->query->get('frequence', PayboxPaymentFrequency::DEFAULT_FREQUENCY));
